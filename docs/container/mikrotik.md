...
/ipv6/address add address=64:ff9b::c0a8:ef01/126 advertise=no comment="nat64 loopback" interface=nat64
#Create veth setup for container
/interface/veth add name=veth-nat64 address=192.168.239.2/30,64:ff9b::c0a8:ef02/126 comment="nat64 veth" dhcp=no gateway=192.168.239.1 gateway6=64:ff9b::c0a8:ef01
...
/ipv6/route add dst=64:ff9b::/96 gateway=64:ff9b::c0a8:ef02%nat64 comment="nat64 translation prefix"
...
#TODO upload image
/container/add envlists=ENV_TAYGA file=tayga.tar interface=veth-nat64 name=tayga-nat64 workdir=/app
```