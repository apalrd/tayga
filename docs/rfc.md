...
RFC7915 implies that we should translate IPv6 addresses in ICMP extensions. TAYGA does not do this. See [Issue #20](https://github.com/apalrd/tayga/issues/20)
